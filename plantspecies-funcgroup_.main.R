...
matrix<- read.csv("C:/Users/suada/OneDrive - University of Pisa/Desktop/Network analysis/plantspecies-funcgroup.csv", sep=";")
...
png("plantspecies_funcgroup.main.png", width = 1400, height = 900, res = 150)
par(mar = c(12, 4, 4, 2))
plotweb(matrix,
        text.rot = 90,
        labsize = 0.9,
