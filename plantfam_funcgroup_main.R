...
matrix<- read.csv("C:/Users/suada/OneDrive - University of Pisa/Desktop/Network analysis/plantfam-funcgroup.csv", sep=";")
...
png("plantfam_funcgroup.main.png", width = 1400, height = 900, res = 150)
par(mar = c(12, 4, 4, 2))
plotweb(matrix,
        text.rot = 90,
        labsize = 0.9,
